<%@ Page Title="Trang chủ" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CayQD._Default" %>
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active slide1">
                <div class="row"><div class="container">
                    <div class="col-md-3 text-right">
                       <!-- <img style="max-width: 200px;"  data-animation="animated zoomInLeft" src="Hinh/209.JPG">-->
                    </div>
            ...
            <div class="item slide2">
                <div class="row"><div class="container">
                    ...
                    <div class="col-md-5 text-right">
                        <%--<img style="max-width: 200px;"  data-animation="animated zoomInLeft" src="Hinh/232.jpg">--%>
                    </div>
                </div></div>
            </div>
            <!-- Item 3 -->
            <div class="item slide3">
                <div class="row"><div class="container">
                    ...
                    <div class="col-md-5 text-right">
                      <%--  <img style="max-width: 200px;"  data-animation="animated zoomInLeft" src="Hinh/Hinh3-VCCI.jpg">--%>
                    </div>     
                </div></div>
            </div>
            <!-- Item 4 -->
            <div class="item slide4">
                <div class="row"><div class="container">
                    ...
                    <div class="col-md-5 text-right">
                       <%-- <img style="max-width: 200px;"  data-animation="animated zoomInLeft" src="Hinh/HInh4-VCCI_n.jpg">--%>
                    </div>  
                </div></div>
            </div>
            <!-- End Item 4 -->
...
/********************************/
#first-slider .slide1 {
    background-image: url('Hinh/209.JPG');
      background-size: cover;
    background-repeat: no-repeat;
}
#first-slider .slide2 {
  background-image:  url('Hinh/232.jpg');
      background-size: cover;
    background-repeat: no-repeat;
}
#first-slider .slide3 {
  background-image: url('Hinh/Hinh3-VCCI.jpg');
      background-size: cover;
    background-repeat: no-repeat;
}
#first-slider .slide4 {
  background-image:  url('Hinh/HInh4-VCCI_n.jpg');
      background-size: cover;
    background-repeat: no-repeat;
}

#first-slider .slide5 {
  background-image:  url('Hinh/IMG_1969.JPG');
      background-size: cover;
    background-repeat: no-repeat;
}

#first-slider .slide6 {
  background-image:  url('Hinh/IMG_3304.JPG');
      background-size: cover;
    background-repeat: no-repeat;
}

#first-slider .slide7 {
  background-image:  url('Hinh/IMG_3328.JPG');
      background-size: cover;
    background-repeat: no-repeat;
}

#first-slider .slide8 {
  background-image:  url('Hinh/IMG_8362.JPG');
      background-size: cover;
    background-repeat: no-repeat;
}
